...
<div class="card">
    <div class="card-body">
        <div class="row justify-content-between">
            <div class="col-md-4">
                <a href="{{ route('rekomendasi.create') }}" class="btn btn-success">Tambah Data</a>
            </div>
            <div class="col-md-4">
        ...
        <table class="table table-hover table-xs" style="font-size: 14px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        <form action="{{ route('rekomendasi.destroy', $item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-link text-danger" onclick="return confirm('Hapus artikel dari rekomendasi ?')"
